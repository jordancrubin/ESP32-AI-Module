...
// Parameters: String word - The word to convert (e.g. "one", "twenty")
//////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////
//-FUNCTION-[processCommand]---Parse and execute local voice commands----]
// Parameters: const String& text - The transcribed voice input text
//////////////////////////////////////////////////////////////////////////
CommandResult CommandProcessor::processCommand(const String& text) {
    ...
    // Local Cmd: Volume 0-10 Spoken -> 0-21 Internal
    if (lowerText.indexOf("lower the volume") != -1 || lowerText.indexOf("decrease the volume") != -1 || lowerText.indexOf("volume down") != -1) {
        ...
        int currentScale = ((settings.brightness - 10) * 10 + 122) / 245; // Conv 10-255 to 0-10
        if (currentScale > 0) currentScale--;
        ...
        while (end != -1 || start < cleanText.length()) {
            ...
            if (word.length() > 0) {
                if (word == "hour" || word == "hours") {
                    ...
                    if (val > 0 || word == "0") {
                        if (lastNum >= 20 && val < 10) lastNum += val; // twenty five -> 25
                        else lastNum = val;
                    }
                }
            }
